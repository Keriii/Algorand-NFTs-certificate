...
class CertificatationClient:
    """A class for interacting with the certificatation app providing high productivity and
    ...
    def __init__(
        ...
        *,
        ...
        """
        CertificatationClient can be created with an app_id to interact with an existing application, alternatively
